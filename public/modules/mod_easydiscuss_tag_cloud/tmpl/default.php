...
<div id="mod-easyblog-tagcloud" class="ezb-mod eblog-module-tagcloud<?php echo $params->get( 'moduleclass_sfx' ) ?>">
	<?php if( !empty( $tagcloud ) ){ ?>
		...
		<a	style="font-size: <?php echo floor($tag->fontsize); ?>px;" class="tag-cloud" href="<?php echo DiscussRouter::getTagRoute( $tag->id ); ?>"><?php echo DiscussStringHelper::escape($tag->title); ?></a>
		<?php } ?>
	<?php } else { ?>
