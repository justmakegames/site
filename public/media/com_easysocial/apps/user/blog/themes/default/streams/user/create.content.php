...
<div class="stream-blog">
	<div class="media">
		<div class="media-body">
			...
			<div class="blog-meta">
				<?php echo JText::sprintf('APP_USER_BLOG_STREAM_META', '<a href="' . $post->getPrimaryCategory()->getPermalink() . '">' . $post->getPrimaryCategory()->title . '</a>', $post->getCreationDate()->format(JText::_('DATE_FORMAT_LC1'))); ?>
			</div>
