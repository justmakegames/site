...
<li class="blog-item clearfix" data-blog-list-item>
	<div class="clearfix">
		...
		<span class="blog-actions btn-group pull-right">
			...
			<ul class="dropdown-menu dropdown-menu-user messageDropDown">
				<li>
					<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=dashboard&layout=write&blogid=' . $post->id );?>"><?php echo JText::_( 'APP_USER_BLOG_EDIT_POST' );?></a>
				</li>
				<li>
					<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=entry&id=' . $post->id );?>"><?php echo JText::_( 'APP_USER_BLOG_DELETE_POST' );?></a>
				</li>
			</ul>
		</span>
		<?php } ?>
	...
	<div class="blog-item-meta clearfix">
		<div class="pull-left">
			<?php echo JText::sprintf( 'APP_USER_BLOG_POSTED_IN_META' , '<a href="' . EasyBlogRouter::_( 'index.php?option=com_easyblog&view=categories&layout=listings&id=' . $post->category_id ) . '">' . $post->category . '</a>' ); ?>
		</div>
	...
	<div class="blog-item-actions row-fluid mt-15">
		...
		<div class="blog-item-actions-comment pull-left small">
			<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=entry&id=' . $post->id );?>#comments">
				<i class="ies-comments-3 ies-small"></i> <?php echo $post->totalComments;?> <?php echo JText::_( 'APP_USER_BLOG_COMMENTS' ); ?>
			</a>
		</div>

		<div class="blog-item-actions-readmore pull-right small">
			<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=entry&id=' . $post->id );?>"><?php echo JText::_( 'APP_USER_BLOG_CONTINUE_READING' ); ?> &rarr;</a>
		</div>
	</div>
