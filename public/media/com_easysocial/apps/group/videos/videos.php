...
class SocialGroupAppVideos extends SocialAppItem
{
    ...
    public function onAfterLikeSave(&$likes)
    {
        ...
        $emailOptions = array(
            'template' => 'apps/group/videos/like.video.item',
            'actor' => $actor->getName(),
        ...
        $ownerTitle = 'APP_GROUP_VIDEOS_EMAILS_LIKE_VIDEO_OWNER_SUBJECT';
        $involvedTitle = 'APP_GROUP_VIDEOS_EMAILS_LIKE_VIDEO_INVOLVED_SUBJECT';
        ...
        $emailOptions['template'] = 'apps/group/videos/like.video.involved';
