...
},500))}),b.resolve()}),EasySocial.module("site/layout/elements",function(a){function c(){try{return document.createEvent("TouchEvent"),!0}catch(a){return!1}}var b=this;a(document).on("click.button.data-bs-api","[data-bs-toggle-value]",function(){var b=a(this),c=b.siblings("[data-bs-toggle-value]"),d=b.parents('[data-bs-toggle="radio-buttons"]');if(!d.hasClass("disabled")&&d.length>0){var e=a(this).data("bs-toggle-value");return b.addClass("active"),c.removeClass("active"),d.find("input[type=hidden]").val(e).trigger("change"),void 0
}}),c()||a(document).on("mouseover.tooltip.data-es-api","[data-es-provide=tooltip]",function(){a(this).tooltip({delay:{show:200,hide:100},animation:!1,template:'<div id="fd" class="es tooltip tooltip-es"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',container:"body"}).tooltip("show")}),a(document).on("mouseover.popover.data-es-api","[data-es-provide=popover]",function(){a(this).popover({delay:{show:200,hide:100},animation:!1,trigger:"hover",container:"body"}).popover("show")});var d=function(a){return a%400?a%100?a%4?!1:!0:!1:!0
};a(document).on("keyup","[data-date-form] [data-date-day]",function(){if(a.trim(a(this).val())){var b=parseInt(a(this).siblings("[data-date-year]").val()||a(this).siblings("[data-date-year]").data("dateDefault")),c=parseInt(a(this).siblings("[data-date-month]").val()||a(this).siblings("[data-date-month]").data("dateDefault")),e=parseInt(a(this).val()||a(this).data("dateDefault")),f=/1|3|5|7|8|10|12/.test(c)?31:30;2==c&&(f=d(b)?29:28),1>e&&(e=1),e>f&&(e=f),a.isNumeric(e)?a(this).val(e):a(this).val("")}}),a(document).on("keyup","[data-date-form] [data-date-year]",function(){if(a.trim(a(this).val())){var b=parseInt(a(this).val());
1>b&&(b=1),a.isNumeric(b)?a(this).val(b):a(this).val("")}}),b.resolve()}),EasySocial.module("site/photos/photos",function(a){var b=this;EasySocial.require().script("site/photos/popup","site/photos/dialog","site/photos/avatar").done(),EasySocial.Controller("Photos",{defaultOptions:{}},function(a){return{init:function(){EasySocial.photos=a,EasySocial.module("site/photos/popup").done(function(b){a.popup=a.addPlugin("popup",b)}),EasySocial.module("site/photos/dialog").done(function(b){a.dialog=a.addPlugin("dialog",b)
...
},"{filters} click":function(b){a.filters().removeClass("active"),b.addClass("active");var d=b.data("filter");a.content().html("&nbsp;"),a.content().addClass("is-loading"),EasySocial.ajax("apps/group/members/controllers/groups/filterMembers",{id:a.options.id,filter:d}).done(function(b){a.content().removeClass("is-loading"),a.content().html(b),a.items().implement(EasySocial.Controller.Groups.Item.Members.Record)})}}}),EasySocial.Controller("Groups.Item.Members.Record",{defaultOptions:{"{makeAdmin}":"[data-members-make-admin]","{revokeAdmin}":"[data-members-revoke-admin]","{approve}":"[data-members-approve]","{reject}":"[data-members-reject]","{removeMember}":"[data-members-remove]","{cancelInvitation}":"[data-members-cancel-invitation]"}},function(a){return{init:function(){a.options.id=a.element.data("id"),a.options.groupId=a.element.data("groupid")
...
EasySocial.require().view("site/links/story/attachment.item").done(function(){EasySocial.Controller("Story.Links",{defaultOptions:{view:{linkItem:"site/links/story/attachment.item"},urlParser:/(^|\s)(https?:\/\/)?(([a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.([a-z]{2,7}))|(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(:[0-9]{1,5})?(\/.*)?/gi,"{linkForm}":"[data-story-link-form]","{linkInput}":"[data-story-link-input]","{linkContent}":"[data-story-link-content]","{linkItem}":"[data-story-link-item]","{linkTitle}":"[data-story-link-title]","{linkDescription}":"[data-story-link-description]","{linkImages}":"[data-story-link-images]","{linkImage}":"[data-story-link-image]","{imageWrapper}":"[data-story-link-image-wrapper]","{linkVideo}":"[data-story-link-video]","{titleTextfield}":"[data-story-link-title-textfield]","{descriptionTextfield}":"[data-story-link-description-textfield]","{panelButton}":"[data-story-link-panel-button]","{attachButton}":"[data-story-link-attach-button]","{removeButton}":"[data-story-link-remove-button]","{removeThumbnail}":"[data-story-link-remove-image]"}},function(b){return{init:function(){b.linkInput().placeholder()
...
},"{story.textField} input":a._.debounce(function(a){if(!b.currentLink&&!b.crawling){var d=a.val(),e=b.extractUrls(d),f=e[e.length-1];if(f){var f=b.fixUrl(f),g=b.links[f];g&&g.disabled||(b.linkInput().val(f),b.doNotFocus=!0,b.panelButton().click(),b.attachButton().click())}}},950),"{story} save":function(a,c,d){if(b.currentLink){var e={title:b.titleTextfield().val(),description:b.descriptionTextfield().val(),url:b.currentLink.url,video:b.linkVideo().val()};b.removeThumbnail().is(":checked")||(e.image=b.imageWrapper(".active").find("img").attr("src")),d.addData(b,e)
}},"{story} clear":function(){b.linkInput().val(""),b.removeLink()}}}),EasySocial.Controller("Story.Links.Item",{defaultOptions:{"{previousImage}":"[data-story-link-image-prev]","{nextImage}":"[data-story-link-image-next]","{image}":"[data-story-link-image]","{imageWrapper}":"[data-story-link-image-wrapper]","{imagesWrapper}":"[data-story-link-images]","{imageIndex}":"[data-story-link-image-index]","{removeThumbnail}":"[data-story-link-remove-image]","{imageDimensions}":"[data-story-link-image-dimensions]","{imageWidth}":"[data-image-width]","{imageHeight}":"[data-image-height]","{title}":"[data-story-link-title]","{description}":"[data-story-link-description]","{titleTextfield}":"[data-story-link-title-textfield]","{descriptionTextfield}":"[data-story-link-description-textfield]"}},function(b){return{init:function(){b.initDimensions()
