EasyBlog.module("composer/blocks/handlers/youtube", function($) {
    ...
    EasyBlog.Controller("Composer.Blocks.Handlers.Youtube", {
        ...
        defaultOptions: $.extend({
            ...
            // Fieldset
            "{related}": "[data-youtube-fieldset-related]",
        ...
        return {
            ...
            "{related} change": function(el, event) {

                // Get the blocks data again.
                var data = blocks.data(currentBlock);
                var showRelated = el.val() == 1;
                var overlay = currentBlock.data('overlay');
                ...
                if (!showRelated) {
                    source = source.replace('?feature=oembed', '?feature=oembed&rel=0');
