	...
	<div class="form-horizontal qtc_buynow" id="<?php echo $this->product_id;?>_item" style="width:auto;">
		...
		?>
			<div class="control-group">
				<label class="control-label"><strong><?php echo JText::_('QTC_ITEM_AMT')?></strong></label>
				<div class="controls qtc_controls_text"><span id="<?php echo ((isset($this->price['discount_price'])) ? $this->product_id.'_price' :'');?>" >
		...
		{ ?>
			<div class="control-group">
				...
				<label class="control-label"><strong><?php echo JText::_('QTC_ITEM_DIS_AMT')?></strong></label>
		...
		if ($this->attributes && empty($this->qtcExtraParam['hideDiscountPrice']))
		{
			...
			{ ?>
				<div class="control-group">
					<label class="control-label "><strong><?php echo $attribute->itemattribute_name; ?></strong></label>
					<?php
						$productHelper = new productHelper ;
		...
		?>
			<div class="control-group <?php echo $hideAtt ?>" >
				<div class="control-label"><strong><?php echo JText::_("COM_QUICK2CART_PROD_FREE_DOWNLOAD"); ?>		</strong></div>
		...
		<div class="control-group" style="<?php echo $showqty_style; ?>">
			<label class="control-label" for="<?php echo $textboxid;?>"><strong><?php echo JText::_('QTC_ITEM_QTY'); ?></strong></label>
			<div class="controls">
