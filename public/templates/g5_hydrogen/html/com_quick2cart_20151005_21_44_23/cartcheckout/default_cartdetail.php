		...
		<tbody>
			<tr>
				...
				<td colspan = "<?php echo $col; ?>">
					<button type="button" class="btn btn-danger btn-small" onclick="emptycart(<?php echo $msg_order_js ?>);" ><i class="icon-trash icon-white"></i>&nbsp;<?php echo JText::_('QTC_BTN_EMPTY_CART')?></button>
				</td>
