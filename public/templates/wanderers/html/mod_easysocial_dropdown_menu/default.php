...
?>
<div class="theme-helper-user pull-right">
    <div id="fd" class="es mod-es-dropdown-menu module-dropdown-menu<?php echo $suffix;?>">
        <div class="mod-bd">

            <?php if ($my->guest) { ?>
                <a href="javascript:void(0);" class="btn btn-default btn-sm btn-menu-logout"
                ...
                >
                    <i class="ies-locked ies-small"></i>
                </a>
                                ...
                                <div class="popbox-dropdown-menu dropdown-menu-login loginDropDown" style="display: block;">
                                    <form action="<?php echo JRoute::_('index.php');?>" method="post">
                                        ...
                                        <ul class="fd-reset-list">
                                            ...
                                            <li class="forget-details">
                                                <div>
                                                    <?php if (!$config->get('registrations.emailasusername')) { ?>
                                                        <a href="<?php echo FRoute::account(array('layout' => 'forgetUsername'));?>" class="fd-small"><?php echo JText::_('MOD_EASYSOCIAL_DROPDOWN_MENU_FORGET_USERNAME');?></a> /
                                                    <?php } ?>
                                                    <a href="<?php echo FRoute::account(array('layout' => 'forgetPassword'));?>" class="fd-small"><?php echo JText::_('MOD_EASYSOCIAL_DROPDOWN_MENU_FORGET_PASSWORD');?></a>
                                                </div>
                                            </li>
            ...
            <?php } else { ?>
                ...
                >
                    ...
                    <span class="dropdown-toggle-user-name top-user-name"><strong><?php echo $my->getName();?></strong></span>
                    ...
                    <ul class="popbox-dropdown-menu dropdown-menu-user mt-5">
                        ...
                        <li class="logout-dropdown">
                            <a href="javascript:void(0);" onclick="document.getElementById('es-dropdown-logout-form').submit();">
                                <i class="ies-switch ies-small mr-5"></i>
