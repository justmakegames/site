...
<div class="view-badges_achievements" data-achievements>
	<div class="row">
		...
		<div class="col-md-3" data-sidebar>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<b><?php echo JText::_( 'COM_EASYSOCIAL_BADGES_ACHIEVEMENTS' );?></b>
				</div>
					...
					<ul class="panel-menu">
						...
						>
							<a href="javascript:void(0);">
								...
								<b data-total-achievements><?php echo $totalBadges;?></b>
							</a>
						</li>
					</ul>
				</div>
		...
		<div class="col-md-9">
			...
			<div class="panel panel-default panel-content" data-achievements-content>
				<div class="panel-body">
					<ul class="achievements-list<?php if( !$badges ){ echo " is-empty"; } ?>">
						<?php if( $badges ){ ?>
