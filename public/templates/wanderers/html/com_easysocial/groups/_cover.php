...
?>
<figure class="header-cover es-header-cover  with-cover">
<div data-group-cover
	 class="es-group-cover es-flyout <?php echo !empty($newCover) ? "editing" : ""; ?>"
	 style="
		background-image   : url(<?php echo $group->getCover();?>);
		background-position: <?php echo $group->getCoverPosition();?>;
     ">
