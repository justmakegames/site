...
<section class="panel panel-default panel-content">
	<header class="panel-heading socialActivities">
		<h4 class="filterbar-title" data-activities-content-title><?php echo $title; ?></h4>
	</header>

	<article class="panel-body" data-activities-content>
