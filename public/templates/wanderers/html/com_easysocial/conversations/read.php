	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="es-sidebar" data-sidebar>
				...
				<div class="es-filter conversation-sidebar">
					<div class="text-center">
						<a href="<?php echo FRoute::conversations();?>" class="btn btn-es btn-sm">
					...
					<h5>
						<?php echo JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_PARTICIPANTS' );?>
					</h5>
					<hr />
					...
					<ul class="list-unstyled conversation-participants">
			...
			<div class="es-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="list-unstyled conversation-messages" data-conversationMessages data-readConversation-items>
