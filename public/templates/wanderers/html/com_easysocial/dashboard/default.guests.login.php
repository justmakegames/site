				...
				<div class="es-login-wrap">
					<form name="loginbox" id="loginbox" method="post" action="<?php echo JRoute::_( 'index.php' );?>">
						...
						<fieldset class="mt-20">
							...
							<div class="checkbox fd-small mt-10">
								<label for="quick-remember">
									<input id="quick-remember" type="checkbox"> <span class="fd-small"><?php echo JText::_( 'COM_EASYSOCIAL_LOGIN_REMEMBER_YOU' );?></span>
								</label>
							</div>

							<button type="submit" class="btn btn-es-success btn-block">
