...
<div class="es-container es-events" data-events data-filter="<?php echo $activeCategory ? 'category' : $filter; ?>" data-categoryid="<?php echo $activeCategory ? $activeCategory->id : 0; ?>">
    <div class="row">
            ...
            <div class="es-sidebar" data-sidebar>
                ...
                <div class="es-widget">
                    <div class="es-widget-head center">
                        <?php if ($this->my->isSiteAdmin() || $this->access->allowed('events.create') && !$this->access->exceeded('events.limit', $this->my->getTotalCreatedEvents())){ ?>
                    ...
                    <div class="es-widget-body">
                        <ul class="widget-list widget-list-with-count fd-nav fd-nav-stacked" data-events-filters>
                            <li
                                ...
                                <a href="<?php echo FRoute::events();?>" title="<?php echo JText::_('COM_EASYSOCIAL_PAGE_TITLE_EVENTS_FILTER_ALL', true);?>"><?php echo JText::_('COM_EASYSOCIAL_EVENTS_FILTER_ALL');?></a>

                                <span class="es-count-no pull-right" data-total-events><?php echo $totalEvents;?></span>
                            </li>
                            <li
                                ...
                                <span class="es-count-no pull-right" data-total-featured><?php echo $totalFeaturedEvents;?></span>
                            </li>
                            ...
                            <li
                                ...
                                <span class="es-count-no pull-right" data-total-created><?php echo $totalCreatedEvents;?></span>
                            </li>
                            <li
                                ...
                                <span class="es-count-no pull-right" data-total-invites><?php echo $totalInvitedEvents;?></span>
                            </li>
                            <?php } ?>
                            <li
                                data-events-filters-type="week1"
                                class="<?php echo $filter == 'week1' && !$activeCategory ? 'active' : '';?>">
                                <a href="<?php echo FRoute::events(array('filter' => 'week1'));?>" title="<?php echo JText::_('COM_EASYSOCIAL_PAGE_TITLE_EVENTS_FILTER_1WEEK', true);?>" ><?php echo JText::_('COM_EASYSOCIAL_EVENTS_FILTER_WEEK1');?></a>
                                <span class="es-count-no pull-right" data-total-invites><?php echo $totalWeek1Events;?></span>
                            </li>
                            <li
                                data-events-filters-type="week2"
                                class="<?php echo $filter == 'week2' && !$activeCategory ? 'active' : '';?>">
                                <a href="<?php echo FRoute::events(array('filter' => 'week2'));?>" title="<?php echo JText::_('COM_EASYSOCIAL_PAGE_TITLE_EVENTS_FILTER_2WEEK', true);?>" ><?php echo JText::_('COM_EASYSOCIAL_EVENTS_FILTER_WEEK2');?></a>
                                <span class="es-count-no pull-right" data-total-invites><?php echo $totalWeek2Events;?></span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="es-widget-body">
                        ...
                        <ul class="widget-list widget-list-with-count fd-nav fd-nav-stacked" data-events-categories data-events-filters>
                            ...
                            >
                                ...
                                <span data-total-events="<?php echo $category->getTotalEvents();?>" class="es-count-no pull-right"><?php echo $category->getTotalEvents();?></span>
                            </li>
                            <?php } ?>
                        </ul>
                        <?php } else { ?>
                ...
                <div class="es-widget">
                    <div class="es-widget-head">
                        <div class="pull-left widget-title"><?php echo JText::_('Calendar');?></div>
                    </div>
        ...
        <div class="col-md-9">
            <div class="es-content pl-20 pt-20 pr-20">
