...
<div class="list-media-options pull-right btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-user messageDropDown">
        ...
        <li>
            <a href="javascript:void(0);"  data-item-action="delete" data-item-delete><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DELETE_EVENT'); ?></a>
        </li>
        <?php } ?>
    </ul>
</div>
...
<div class="media">
    ...
    <div class="media-body">
        ...
        <div class="media-meta mt-5 muted">
            ...
            <div>
                ...
                <span>
                    ...
                    <?php echo $event->getEventStart()->format(JText::_($this->config->get('events.timeformat') == '12h' ? 'COM_EASYSOCIAL_DATE_12H' : 'COM_EASYSOCIAL_DATE_24H'), true); ?><?php if ($event->hasEventEnd()) { ?> – <?php echo $event->getEventEnd()->format(JText::_($this->config->get('events.timeformat') == '12h' ? 'COM_EASYSOCIAL_DATE_12H' : 'COM_EASYSOCIAL_DATE_24H'), true); ?><?php } ?>
                </span>
            </div>
        ...
        <?php // echo $this->loadTemplate('site/events/item.guestState', array('event' => $event, 'guest' => $guest, 'params' => $event->getParams())); ?>
    </div>
</div>
