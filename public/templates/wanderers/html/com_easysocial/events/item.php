                ...
                <div class="es-widget">
                    ...
                    <div class="es-widget-body">
                        ...
                        <ul class="widget-list fd-nav fd-nav-stacked" data-filter-stream-list>
                            ...
                            <li class="<?php echo empty($contents) ? 'active' : '';?>" data-sidebar-item>
                            ...
                            <li class="widget-filter-group">
                                ...
                                <?php foreach ($appFilters as $appFilter) { ?>
                                    <?php echo $this->includeTemplate('site/events/item.filter.app', array('filter' => $appFilter, 'hide' => $i > $this->template->get('events_feeds_apps_total') && $this->template->get('events_feeds_apps_total') != 0)); ?>
                                    <?php $i++; ?>
                                <?php } ?>
