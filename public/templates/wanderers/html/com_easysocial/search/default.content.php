...
?>
<div style="background:#fff; border:1px solid #d7d7d7; padding:20px;">
	<form name="frmSearch" method="post" action="<?php echo JRoute::_( 'index.php' );?>">
		<div class="search-input-wrap mt-10 pl-10">
			<div class="input-group">
				<input type="text" class="form-control xinput-search" id="appendedInputButton" value="<?php echo $this->html( 'string.escape' , $query ); ?>" name="q" data-search-query>
