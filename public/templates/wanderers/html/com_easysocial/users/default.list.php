				...
				<div class="es-item">
					...
					<div class="es-item-body">
						...
						<div class="es-item-detail">
							...
							<ul class="list-unstyled list-inline user-meta">
								<li>
							...
							<div class="user-actions">
								...
								<?php if( $this->config->get('conversations.enabled') && Foundry::privacy( $this->my->id )->validate( 'profiles.post.message' , $user->id ) && $this->access->allowed( 'conversations.create' ) ){ ?>
								<span>
