...
?>
<li class="fd-small es-comment" data-comments-item data-id="<?php echo $comment->id; ?>">
	<div class="media es-flyout">
		...
		<div class="media-body">
				...
				<div class="es-comment-actions es-flyout-content" data-comments-item-actions>
					<div class="es-comment-actions-flyout">
						...
						<ul class="fd-nav fd-nav-stacked pull-right es-comment-actions-nav">
							...
							<li>
								<?php echo Foundry::reports()->getForm( 'com_easysocial', 'comments', $comment->id, JText::sprintf( 'COM_EASYSOCIAL_COMMENTS_REPORT_ITEM_TITLE' , $user->getName() ) , JText::_( 'COM_EASYSOCIAL_COMMENTS_REPORT_ITEM' ), '' , JText::_( 'COM_EASYSOCIAL_COMMENTS_REPORT_TEXT' ) , '' ); ?>
							</li>
							<?php } ?>
			...
			<?php if( $this->config->get( 'comments.reply' ) ) { ?>
			<div data-comments-item-viewReplies class="es-comment-item-viewreply">
				<a href="javascript:void(0);">View replies</a>
			</div>
			<?php } ?>
			...
			<div data-comments-item-frame data-comments-item-editFrame style="display: none;">
				...
				<a class="btn btn-es-primary btn-sm pull-right ml-10" href="javascript:void(0);" data-comments-item-edit-submit><?php echo JText::_( 'COM_EASYSOCIAL_COMMENTS_ACTION_SUBMIT' ); ?></a>
