...
?>
<div data-layout="dialog" data-album-browser="<?php echo $uuid; ?>" class="es-container es-media-browser row layout-dialog" >
	<div class="col-md-4">
	...
	<div class="col-md-8" >
		<div data-album-browser-content class="es-content" style="margin: 20px 0 0;"><?php echo $content; ?></div>
	</div>
</div>
