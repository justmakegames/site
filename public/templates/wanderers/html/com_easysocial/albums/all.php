			...
			<div class="es-content">
				<div class="row">
					<div class="col-md-12 ml-20">
						<h5 class="pull-left mt-20"><?php echo JText::_( 'COM_EASYSOCIAL_ALBUMS_PHOTO_ALBUMS' ); ?></h5>

						<div class="btn-group btn-group-view-apps pull-right mt-20 mr-20 pr-20" data-apps-sorting>
				...
				<div class="es-content-wrap" data-albums-content>
