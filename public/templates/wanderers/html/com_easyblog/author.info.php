...
<div id="section-author" class="blog-section clearfix mts mbs">
	...
	<div class="">
		<!-- Author avatar -->
		<h5 class="author-header">About the author</h5>
		...
		<div class="author-meta profile-connect mtm pll prl">
		...
		<div class="clear"></div>		
		<div class="mtm">
			<h5 class="authorrecentpost"><?php echo JText::_('COM_EASYBLOG_AUTHOR_RECENT_POSTS'); ?></h5>
			<div class="pll prl pbl">
