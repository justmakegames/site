...
<?php if( $posts ){ ?>
	<div class="list-item">
		...
		<div class="item">
			<div class="story">
				<?php if( $params->get( 'show_avatar' , 1 ) || $params->get( 'show_startedby' , 1 ) ){ ?>
			...
			<a class="readmore" href="<?php echo DiscussRouter::_( 'index.php?option=com_easydiscuss&view=post&id=' . $post->id );?>#reply-<?php echo $post->id;?>">
				Read more...
			</a>
			<div class="both"></div>
		</div>
