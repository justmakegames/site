...
<article class="item-page<?php echo $this->pageclass_sfx?>">
	...
	<header>
		...
		<?php if ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon') || ($params->get('show_create_date')) || ($params->get('show_publish_date')) || ($params->get('show_modify_date'))) : ?>
		<ul>	
			<?php if ($params->get('show_publish_date')) : ?>
			<li class="published">
				<time pubdate="<?php echo JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC2')); ?>">
					<?php echo JHtml::_('date', $this->item->publish_up, JText::_('d M Y h:i')); ?>
				</time>
			</li>			
			<?php elseif ($params->get('show_modify_date')) : ?>
			<li class="modified">
				<time pubdate="<?php echo JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_LC2')); ?>">
