	...
	<header>
		...
		<?php if (($params->get('show_author')) or ($params->get('show_parent_category')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_publish_date'))  or ($params->get('show_hits')) or ($params->get('show_create_date')) ) : ?>
			<ul>				
				...
				<li class="modified">
                  <time pubdate="<?php echo JHtml::_('date', $item->modified, JText::_('DATE_FORMAT_LC2')); ?>">
                  	<?php echo JHtml::_('date', $item->modified, JText::_('d M Y h:i')); ?>
                  </time>
				</li>
				<?php endif; ?>
				...
				<li class="published">
                  <time pubdate="<?php echo JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_LC2')); ?>">
                  	<?php echo JHtml::_('date', $item->publish_up, JText::_('d M Y h:i')); ?>
                  </time>
				</li>
				<?php endif; ?>
				...
				<li class="created">
					<time pubdate="<?php echo JHtml::_('date', $item->created, JText::_('DATE_FORMAT_LC2')); ?>">
						<?php echo JHtml::_('date', $item->created, JText::_('d M Y h:i')); ?>
					</time>
				</li>
				<?php endif; ?>
				...
				<li class="item-date">
                  <time datetime="<?php echo JHtml::_('date', $item->created, 'Y-m-d'); ?>">
					<?php echo JHtml::_('date', $item->created, JText::_('d M')); ?>
                  </time>
				</li>
				<?php endif; ?>
			</ul>
