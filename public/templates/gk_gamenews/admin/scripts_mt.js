...
if(document.id('jform_params_tools').value == 'selected' || document.id('jform_params_tools').value == 'selected_disabled') document.id('jform_params_tools_for_pages-lbl').getParent().setStyle('display','block');
	...
	// overrides
	['layout_override', 'tools_for_pages', 'suffix_override', 'module_override'/*, 'menu_override'*/, 'mootools_for_pages', 'sidebar_width_for_pages'].each(function(txt) {
...
function getUpdates() {
	...
	var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_gamenews_j25';
...
'https://wiki.gavick.com/joomla-templates/templates-for-joomla-1-6/gavern-framework/gavern-framework-refreshed-typography/',
'https://wiki.gavick.com/joomla-templates/templates-for-joomla-1-6/gavern-framework/gavern-framework-menu/',
'https://wiki.gavick.com/joomla-templates/templates-for-joomla-1-6/gavern-framework/gavern-framework-mobile-version/',
