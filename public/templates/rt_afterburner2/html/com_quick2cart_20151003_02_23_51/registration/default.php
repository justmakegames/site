		...
		<div id="qtc_user-info-content">
			<div class="row-fluid" >
				<div class="left span6">
					...
					<!-- registration -->
					  ...
					  <label for="register" title="<?php echo JText::_('COM_QUICK2CART_CHECKOUT_REGISTER_DESC'); ?>">
						...
						<b><?php echo JText::_('COM_QUICK2CART_CHECKOUT_REGISTER'); ?></b></label>
					  <br />
					  <?php endif; ?>
					  ...
					  <label for="guest">
						...
						<b><?php echo JText::_('COM_QUICK2CART_CHECKOUT_GUEST'); ?></b></label>
					  <br />
					  <?php endif; ?>
					  <br />
				...
				<div id="login" class="right span6">
					  ...
					  <br />
					  <br />
					  <input type="button" value="<?php echo JText::_('COM_QUICK2CART_CHECKOUT_LOGIN'); ?>" id="button-login" class="button btn " onclick="qtc_ckpg_login(this)"/><br />
					  <br />
				</div>
			</div>
			<hr/>
			<div class="row-fluid">
				<input type="button" class="button btn btn-primary" id="button-user-info" value="<?php echo JText::_('COM_QUICK2CART_CONTINUE');?>" onclick="qtc_guestContinue('qtc_user-info-content')">
			</div>
		</div>
