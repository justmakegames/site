						...
						<tr>
							...
							if (!$orders_site)
							{
								...
								<th class='q2c_width_5 nowrap hidden-phone hidden-tablet '>
									<?php echo JHtml::_('grid.sort', 'COM_QUICK2CART_ID', 'id', $this->lists['order_Dir'], $this->lists['order']); ?>
								</th>
								<?php
							}
							?>
					...
					<tbody>
							...
							<tr class="<?php echo $row_color; ?>">
								...
								<td class='small' data-title="<?php echo JText::_('QTC_ORDER_ID');?>">
									...
									if ($orders_site)
									{
										...
										<br/>
										<span class="small">
											<?php echo JText::_('COM_QUICK2CART_ID');?> : <?php echo $orders->id;?>
										</span>
										<?php
									}
									?>
								...
								{
									?>
										<td class='q2c_width_10 hidden-phone hidden-tablet  small nowrap' data-title="<?php echo JText::_('COM_QUICK2CART_ORDERS_GATEWAY');?>">
										<?php $this->paidPlgName = $this->comquick2cartHelper->getPluginName($orders->processor);
										//$plgname = !empty($this->paidPlgName)?$this->paidPlgName:$orders->processor;
								...
								{
									?>
									<td class="q2c_width_15 small" data-title="<?php echo JText::_('QTC_USERNAME');?>">
										<?php
								...
								<td class="qtc_pending_action q2c_width_30 small " data-title="<?php echo JText::_('QTC_ORDER_STATUS');?>">
									...
									else if(!empty($this->storeReleatedView))
									{
										...
										echo JHtml::_('select.genericlist', $temp_vendorstatus, "vendor_orderItemStatus", 'class="pad_status input-small pull-left" size="1" ;" autocomplete="off"', "value", "text", $orders->status, 'pstatus' . $orders->id);
									}
									else
									{
										echo $whichever ;
									...
									{ ?>
										...
										<a class="btn btn-success btn-mini validate" href="<?php echo JUri::base().substr(JRoute::_('index.php?option=com_quick2cart&view=orders&layout=order&orderid=' . $orders->id . '&Itemid=' . $this->orderDetailItemId . '&paybuttonstatus=1'), strlen(JUri::base(true)) + 1) . '#complete-order';?>">
											<?php echo JText::_('QTC_ORDER_COMPLETE_PAYMENT');?>
										</a>
										<?php
									}
									...
									{ ?>
										...
										<button type="button" class="btn btn-small" onClick="updateOrderStatus(<?php echo $orders->id; ?>, this);"><?php echo JText::_('COM_QUICK2CART_ORDER_STATUS_UPDATE');?></button>
								...
								<!-- Order price-->
								<td class="q2c_width_10 nowrap" data-title="<?php echo JText::_('QTC_AMOUNT');?>">
									<?php
								...
								{
									?>
									<td class="q2c_width_5 nowrap hidden-phone hidden-tablet  small " data-title="<?php echo JText::_('COM_QUICK2CART_ID');?>">
										<?php
											echo $orders->id;
										?>
									</td>
						...
						if ($orders_site)
						{
							...
							<tr>
								...
								<td ><b><?php echo JText::_('QTC_PRODUCT_TOTAL'); ?></b></td>
							...
							if (!empty($this->storeReleatedView))
							{
								...
								<tr>
									<td colspan="<?php echo $colspan;?>"></td>
									<td align="center"><strong><?php echo sprintf(JText::_('QTC_COMMISSION_CUT_SUB_TOT'),'('.$commission.'%)'); ?> </strong></td>
								...
								<tr>
									<td colspan="<?php echo $colspan;?>"></td>
									<td align="center"><strong><?php echo JText::_('QTC_TOTAL'); ?> </strong></td>
									<td data-title="<?php echo JText::_('QTC_COMMISSION_CUT_SUB_TOT');?>">
										<span>
