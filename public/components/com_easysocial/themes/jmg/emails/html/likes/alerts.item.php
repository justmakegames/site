    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <span style="margin-bottom:15px;">
            <span style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_CONTENT_NEW_LIKE_ITEM_TITLE', $posterName); ?>
            </span>
        </span>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;font-size:12px;color:#888">
        ...
        <p style="text-align:left;padding: 0 30px;">
            <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_CONTENT_NEW_LIKE_ITEM_BODY', $posterName);?>
        </p>
        ...
        <a style="
                ...
                " href="<?php echo $link;?>"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_CONTENT_NEW_LIKE_ITEM_VIEW');?></a>
        <?php } ?>
    </td>
</tr>
