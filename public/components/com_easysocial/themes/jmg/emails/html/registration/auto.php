            ...
            <tr>
                    ...
                    <table width="250" align="center">
                        <tr>
                            <td valign="top" style="padding: 10px 0;">
                                <img src="<?php echo rtrim( JURI::root() , '/' );?>/components/com_easysocial/themes/jmg/images/emails/icon-user.png" alt="" />
                            </td>
                ...
                <td>
                    <table width="250" align="center">
                        <tr>
                            <td valign="top" style="padding: 10px 0;">
                                <img src="<?php echo rtrim( JURI::root() , '/' );?>/components/com_easysocial/themes/jmg/images/emails/icon-invite.png" alt="" />
                            </td>
                            <td valign="top" style="text-align:left;padding: 10px 0;font-size:12px;">
