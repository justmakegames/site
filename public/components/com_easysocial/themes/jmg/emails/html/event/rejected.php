    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::_('COM_EASYSOCIAL_EMAILS_EVENT_REJECTED_HEADING'); ?>
            </div>
            <div style="font-size:12px; color: #798796;font-weight:normal">
                <?php echo JText::_('COM_EASYSOCIAL_EMAILS_EVENT_REJECTED_SUBHEADING'); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="font-size:12px;color:#888;padding: 0 30px;">
        ...
        <p>
            <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_EVENT_REJECTED_CONTENT' , $title); ?>
        </p>

        <?php if(!empty($reason)){ ?>
        <p style="margin-top: 20px;">
            <?php echo JText::_('COM_EASYSOCIAL_EMAILS_EVENT_REJECTED_REASON'); ?>
        </p>
