    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_APPLICATION_APPROVED_HEADING' ); ?>
            </div>
            <div style="font-size:12px; color: #798796;font-weight:normal">
                <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_APPLICATION_APPROVED_SUBHEADING' ); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;">
        ...
        <p style="margin-bottom: 50px;">
            <?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_GROUP_APPROVED' , $title ); ?>
        </p>
        ...
        <a href="<?php echo $groupUrl;?>" style="
        ...
        "><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_VIEW_GROUP' ); ?></a>
        ...
        <table width="520" align="center" style="border:1px solid #ebebeb" border="0" cellspacing="0" cellpadding="0">
            <tr>
                    ...
                    <table width="250" align="center">
                        <tr>
                            <td valign="top" style="padding: 10px 0;">
                                <img src="<?php echo rtrim( JURI::root() , '/' );?>/components/com_easysocial/themes/jmg/images/emails/icon-group.png" alt="" />
                            </td>
                            <td valign="top" style="text-align:left;padding: 10px 0;font-size:12px;">
                                <a href="<?php echo $editUrl;?>" style="text-decoration:none;color:#00aeef;">
                                    <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_UPDATE_YOUR_GROUP' ); ?>
                                </a>
                                <p style="margin: 5px 0 0;color:#888;">
                                    <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_UPDATE_YOUR_GROUP_DESC' ); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <td style="background:#ebebeb" width="1">
                    <img src="<?php echo rtrim( JURI::root() , '/' );?>/components/com_easysocial/themes/jmg/images/emails/spacer.gif" alt="" width="1" />
                </td>
                <td>
                    <table width="250" align="center">
                        <tr>
                            <td valign="top" style="padding: 10px 0;">
                                <img src="<?php echo rtrim( JURI::root() , '/' );?>/components/com_easysocial/themes/jmg/images/emails/icon-discussion.png" alt="" />
                            </td>
                            <td valign="top" style="text-align:left;padding: 10px 0;font-size:12px;">
                                <a href="<?php echo $groupUrl;?>" style="text-decoration:none;color:#00aeef;">
                                    <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_START_DISCUSSION' ); ?>
                                </a>
                                <p style="margin: 5px 0 0;color:#888;">
                                    <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_START_DISCUSSION_DESC' ); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
