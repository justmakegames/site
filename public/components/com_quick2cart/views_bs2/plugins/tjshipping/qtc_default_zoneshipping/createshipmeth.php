...
<form name="qtcshipform" id="adminForm" class="form-validate form-horizontal" method="post" onSubmit="return myValidate(this);" >
	...
	<div class="row-fluid">
		...
		<div class="control-group">
			<label  for="name" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_METH_NAME_TITLE'); ?>">
		...
		?>
		<div class="control-group">
			<label for="qtcShipMethStoreId" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_STORE_NAME_DESC'); ?>">
		...
		?>
		<div class="control-group">
			<label  for="taxprofileId" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPTAXPROFILE_HELP_TITLE'); ?>">
		...
		?>
		<div class="control-group">
			<label  for="shipstate" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_STATE_TITLE'); ?>">
		...
		?>
		<div class="control-group" >
			<label  for="shipping_type" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPTYPE_TITLE'); ?>">
		...
		?>
		<div class="control-group">
			<label  for="qtcMinAmount" class="control-label" title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_MINIMUM_AMT_TITLE'); ?>" id="qtcCreateMethMinFieldLable">
		...
		<div class="control-group">
			<label  for="qtcMaxAmount" class="control-label"  title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_MAXIMUM_AMT_TITLE'); ?>" id="qtcCreateMethMaxFieldLable">
		...
		<div class="form-actions ">
			<div class="qtc_action_button filter-search ">
				...
				<button type="button" class="btn  " title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_S_SAVE_CLOSE'); ?>" onclick="qtcShipSubmitAction('shipMethodSaveAndClose');">
