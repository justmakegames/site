...
$js = "
	...
	function refreshViews()
	{
		...
		techjoomla.jQuery.ajax({
			type: 'GET',
			url: 'index.php?option=com_quick2cart&task=vendor.refreshVendorDashboard&fromDate='+fromDate+'&toDate='+toDate+'&storeid=2',
			async:false,
			dataType: 'json',
														...
														<table class="table table-striped table-hover table-bordered">
															<thead>
																<tr>
																	...
																	<th class="hidden-phone"><?php echo JText::_('COM_QUICK2CART_DASHB_DATE'); ?></th>
