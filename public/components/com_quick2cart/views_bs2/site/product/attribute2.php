	...
	<div class="qtcMarginTop10px table-responsive">
		<table class="table table-condensed removeMargin qtc_attributeOpTable" style="<?php echo $tableDisplay; ?>"><!-- the table width is fixed to 450px -->
			...
			<tr class="form-inline clonedInput" id="attri_opts<?php echo $k; ?>" >
				...
				{
					?>
					 <button type="button" class="btn btn-mini btn-danger qtcRemoveOption" id="btnRemove<?php echo $k; ?>" title="<?php echo JText::_('QTC_REMOVE_MORE_OPTION_TITLE');?>" onclick="techjoomla.jQuery(this).closest('tr').remove();" ><i class="<?php echo Q2C_ICON_TRASH;?> icon-white"></i></button>
					<?php
				}
				?>
				</td>
