...
class Quick2cartControllerShipprofileform extends Quick2cartController
{
	...
	public function edit()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_quick2cart&view=shipprofileform&l&id='.$editId, false));
	}
	...
	public function save()
	{
		...
		if ($task == "save")
		{
			$this->setRedirect(JRoute::_('index.php?option=com_quick2cart&view=shipprofileform&id='.$return.'&Itemid='.$itemid,false));
		}
		else
		{
			$this->setRedirect(JRoute::_('index.php?option=com_quick2cart&view=shipprofiles&id='.$return.'&Itemid='.$itemid,false));
		}
...
//$response = array ("error"=>0,"shipProfileMethodId"=>"3");
	 ...
	 * @since	2.2
	 */
	function deleteShipProfileMethod()
	{
		$app = JFactory::getApplication();
