 ...
 * @since       2.2
 */
//class Quick2cartControllerCategory extends JControllerAdmin
class Quick2cartControllerCategory extends quick2cartController
{
	...
	/**
	 * This function change statu of products
	 * */
	...
	{
		$this->text_prefix = "COM_QUICK2CART";
		...
		$this->setRedirect('index.php?option=com_quick2cart&view=category&layout=my&qtcStoreOwner=1');
	}*/
