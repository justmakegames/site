...
class Quick2cartControllerTaxrateForm extends Quick2cartController
{
	...
	public function edit()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_quick2cart&view=taxrateform&id='.$editId, false));
	}
	...
	public function remove() {
		...
		if ($data === false) {
			...
			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_quick2cart.edit.taxrateform.id');
			$this->setRedirect(JRoute::_('index.php?option=com_quick2cart&view=taxrate&layout=edit&id=' . $id, false));
			return false;
		}
