...
class StoreHelper
{
	...
	public function getStoreLink($store_id)
	{
		...
		$link      = JUri::root() . substr(JRoute::_($mainlink), strlen(JUri::base(true)) + 1);
	 ...
	 *
	 * @param   integer  $store_id       total price.
	 * @param   integer  $order_user_id  Order user id.
	 *
	 * @since   2.2
	 * @return  boolean.
	 */
	public function allowToViewStoreOrderDetailView($store_id, $order_user_id)
	{
		$user   = JFactory::getUser();
		$userid = $user->id;
