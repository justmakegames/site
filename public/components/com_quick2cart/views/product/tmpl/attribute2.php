...
-->
			...
			<tr>
				<td data-title="<?php echo JText::_('QTC_ADDATTRI_NAME');?>">
					<input id="atrri_name" name="att_detail[<?php echo $i; ?>][attri_name]" class="input-medium bill inputbox qtc_attrib " type="text" value="<?php echo (isset($this->allAttribues[$i]->itemattribute_name)) ? htmlentities($this->allAttribues[$i]->itemattribute_name) : ''; ?>" maxlength="250"  title="<?php echo JText::_('QTC_ADDATTRI_NAME_DESC')?>">
					<!-- Hidded field -->
					<input id="atrri_name_id" name="att_detail[<?php echo $i; ?>][attri_id]" class="input-medium bill inputbox " type="hidden" value="<?php echo (isset($this->allAttribues[$i]->itemattribute_id))?$this->allAttribues[$i]->itemattribute_id:''; ?>" maxlength="250"  title="<?php echo JText::_('QTC_ADDATTRI_NAME_DESC')?>">
				</td>
...
-->
			...
			<tr class="form-inline clonedInput" id="attri_opts<?php echo $k; ?>" >
				...
				{ ?>
					 <button type="button"  class="btnAdd btn btn-mini btn-primary" id="<?php echo "qtc_container". $i;?>" title="<?php echo JText::_('QTC_ADD_MORE_OPTION_TITLE')?>" onclick="addopt(this.id);"><i class="<?php echo QTC_ICON_PLUS;?> icon-white"></i></button>
					<?php
				}
				else
				{
					?>
					 ...
					 <i class="<?php echo Q2C_ICON_TRASH;?> icon-white"></i>
					 </button>
					<?php
				}
				?>
