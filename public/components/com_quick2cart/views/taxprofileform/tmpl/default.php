...
<script type="text/javascript">
	...
	function qtcDeleteProfileRule(ruleId,delBtn)
	{
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=taxprofileform&task=taxprofileform.deleteProfileRule",
			data : data,
    ...
    function qtc_addTaxRule()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=taxprofileform&task=taxprofileform.addTaxRule",
					data : data,
					dataType: "json",
					success : function(response)
					{
	...
	<div class="row">
		<div class="form-horizontal">
						...
						{ ?>
							<tr>
								...
								<td>
									...
									href="index.php?option=com_quick2cart&view=taxprofileform&layout=setrule&id=<?php echo $trule->taxrule_id;?>&tmpl=component" class="modal">
			...
			<div class=" ">
					...
					<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=taxprofileform.cancel&id='.$this->item->id); ?>" class="btn btn-default" title="<?php echo JText::_('COM_QUICK2CART_CANCEL_ITEM'); ?>">
