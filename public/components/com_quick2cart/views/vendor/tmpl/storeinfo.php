								...
								<p>
									...
									else
									{
										...
										if ($limit < $description_length)
										{
											// SHOE READ MORE LINK
											?>
											<a title="<?php echo JText::_('QTC_READMORE')?>" class="modal" rel="{handler: 'iframe', size: {x: window.innerWidth-350, y: window.innerHeight-150}, onClose: function(){}}" href="<?php echo $storeinfo_link;?>" style="display:inline-block;">
