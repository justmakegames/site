		...
		<div class="table-responsive" id='no-more-tables'>
			<table width="100%" class="table table-condensed table-bordered  " style="<?php echo $this->email_table_bordered; ?>">
				...
				foreach ($this->orderitems as $order)
				{
					...
					<tr class="row0">
						<td class="cartitem_num" data-title="<?php echo JText::_('QTC_NO');?>"><?php echo $i++;?></td>
						<td class="cartitem_name" data-title="<?php echo JText::_('QTC_PRODUCT_NAM');?>">
							<?php
						...
						if ($showoptioncol == 1)
						{ ?>
							<td class="cartitem_opt" data-title="<?php echo JText::_('QTC_PRODUCT_OPTS');?>">
							<?php
