...
class quick2cartViewzones extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_QUICK2CART_ZONES_PAGE_TITLE'));
		}

		$title = $this->params->get('page_title', JText::_('COM_QUICK2CART_ZONES_PAGE_TITLE'));

		// @TODO - hack * remove line below -when correct itemid is passed for this view
		$title = JText::_('COM_QUICK2CART_ZONES_PAGE_TITLE');
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('zoneform.edit', 'TJTOOLBAR_EDIT', '', 'btn btn-small btn-success');
		}*/
