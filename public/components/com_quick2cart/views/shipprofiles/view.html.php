...
class Quick2cartViewShipprofiles extends JViewLegacy
{
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('shipprofileform.add', 'TJTOOLBAR_NEW', '', 'btn btn-small btn-success');
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('shipprofiles.publish', 'TJTOOLBAR_PUBLISH', '', 'btn btn-small btn-success');
				$tjbar->appendButton('shipprofiles.unpublish', 'TJTOOLBAR_UNPUBLISH', '', 'btn btn-small btn-warning');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('shipprofiles.delete', 'TJTOOLBAR_DELETE', '', 'btn btn-small btn-danger');
			}
		}
