				...
				foreach ($this->shipMethods as $meths)
				{
					...
					<tr>
						...
						<td>
							...
							href="index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?>&layout=setrule&id=<?php echo $meths->shipprofile_id;?>&shipmethId=<?php echo $meths->id; ?>&tmpl=component" class="modal">
