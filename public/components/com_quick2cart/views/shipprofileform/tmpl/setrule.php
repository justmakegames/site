...
function qtcLoadPlgMethods()
{
    ...
    function qtc_updateShipMethod()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=shipprofileform&task=shipprofileform.updateShipMethod",
					data : data,
					dataType: "json",
					beforeSend: function()
					{
...
<div class=" <?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	...
	<div class="" id="no-more-tables">
		...
		<table class="table table-striped table-bordered">
			<tr>
				<td data-title="<?php echo JText::_('COM_QUICK2CART_SHIPPROFILE_PROVIDER');?>">
					<?php echo $this->shipPluglist; ?>
				</td>
				<td data-title="<?php echo JText::_('COM_QUICK2CART_SHIPPROFILE_METHOD');?>">
