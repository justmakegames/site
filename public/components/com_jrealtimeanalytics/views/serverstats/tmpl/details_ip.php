...
<div class="jes">
	...
	<a class="headstats btn btn-primary btn-xs csv" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntitycsv&amp;tmpl=component&amp;details=ip&amp;identifier=' . rawurlencode($this->app->input->get('identifier')));?>">
		<span class="icon-chart"></span>
		<?php echo JText::_('COM_JREALTIME_EXPORTCSV' ); ?>
	</a>
	<a class="headstats btn btn-primary btn-xs xls" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntityxls&amp;tmpl=component&amp;details=ip&amp;identifier=' . rawurlencode($this->app->input->get('identifier')));?>">
		<span class="icon-chart"></span>
		<?php echo JText::_('COM_JREALTIME_EXPORTXLS' ); ?>
	</a>
	<a class="headstats btn btn-primary btn-xs pdf" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&task=serverstats.showEntitypdf&tmpl=component&details=ip&identifier=' . rawurlencode($this->app->input->get('identifier')));?>">
		<span class="icon-chart"></span>
