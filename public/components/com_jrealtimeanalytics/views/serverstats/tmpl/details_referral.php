...
<div class="jes">
						...
						?>
							<tr>
								...
								<td><?php if($userDetail->geolocation) : ?>
										...
										<img src="<?php echo $this->livesite;?>/administrator/components/com_jrealtimeanalytics/images/flags/<?php echo strtolower($userDetail->geolocation);?>.png"/>
									<?php else : ?>
	...
	<a class="headstats btn btn-primary btn-xs csv" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntitycsv&amp;tmpl=component&amp;details=referral&amp;identifier=' . rawurlencode($this->app->input->getString('identifier')));?>">
		<span class="icon-chart"></span>
		<?php echo JText::_('COM_JREALTIME_EXPORTCSV' ); ?>
	</a>
	<a class="headstats btn btn-primary btn-xs xls" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntityxls&amp;tmpl=component&amp;details=referral&amp;identifier=' . rawurlencode($this->app->input->getString('identifier')));?>">
		<span class="icon-chart"></span>
		<?php echo JText::_('COM_JREALTIME_EXPORTXLS' ); ?>
	</a>
	<a class="headstats btn btn-primary btn-xs pdf" download href="<?php echo JRoute::_('index.php?option=com_jrealtimeanalytics&task=serverstats.showEntitypdf&tmpl=component&details=referral&identifier=' . rawurlencode($this->app->input->getString('identifier')));?>">
		<span class="icon-chart"></span>
