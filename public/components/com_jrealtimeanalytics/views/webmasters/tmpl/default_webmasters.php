			...
			<div class="accordion-group span12">
				<div class="accordion-heading">
					<div class="accordion-toggle accordion_lightblue" data-toggle="collapse" data-parent="#jrealtime_googleconsole_query_accordion" href="#jrealtime_google_pages">
						<h3><span class="glyphicon glyphicon-file"></span> <?php echo JText::_ ('COM_JREALTIME_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_PAGES' ); ?></h3>
					</div>
				</div>
				<div id="jrealtime_google_pages" class="accordion-body accordion-inner collapse" >
					<table class="adminlist table table-striped table-hover table-webmasters">
						<thead>
							<tr>
								<th>
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_PAGES' ); ?></span>
								</th>
								<th class="title">
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_CLICKS' ); ?></span>
								</th>
								<th class="title">
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_IMPRESSION' ); ?></span>
								</th>
								<th class="title">
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_CTR' ); ?></span>
								</th>
								<th class="title">
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_POSITION' ); ?></span>
								</th>
							</tr>
						</thead>
			...
			<div class="accordion-group span12">
				<div class="accordion-heading">
					<div class="accordion-toggle accordion_lightblue" data-toggle="collapse" data-parent="#jrealtime_googleconsole_accordion" href="#jrealtime_google_query">
						<h3><span class="glyphicon glyphicon-list"></span> <?php echo JText::_ ('COM_JREALTIME_GOOGLE_WEBMASTERS_STATS_KEYWORDS_BY_QUERY' ); ?></h3>
					</div>
				</div>
				<div id="jrealtime_google_query" class="accordion-body accordion-inner collapse" >
					<table class="adminlist table table-striped table-hover table-webmasters">
						<thead>
							<tr>
								<th>
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_KEYS' ); ?></span>
								</th>
								<th class="title">
									<span class="label label-info"><?php echo JText::_('COM_JREALTIME_GOOGLE_WEBMASTERS_CLICKS' ); ?></span>
								</th>
