...
//Theme for template
$theme_color = $template->params->get('theme_color', 'default');

if (file_exists ( JPATH_ROOT . "/templates/{$app->getTemplate()}/css/colors/".$theme_color.".css" )) {
  CKunenaTools::addStyleSheet ( JURI::root(true). "templates/{$app->getTemplate()}/css/colors/".$theme_color.".css" );
} else {
  $template->addStyleSheet ( 'css/colors/'.$theme_color.'.css' );
}

// Get custom for template
if (file_exists ( JPATH_ROOT . "/templates/{$app->getTemplate()}/css/nts-kpraxis-custom.css" )) {
	CKunenaTools::addStyleSheet ( JURI::root(true). "/templates/{$app->getTemplate()}/css/nts-kpraxis-custom.css" );
}
