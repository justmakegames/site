...
class N2SSPluginWidgetBarVertical extends N2SSPluginWidgetAbstract
{
    ...
    static function render($slider, $id, $params) {
        ...
        N2CSS::addFile(N2Filesystem::translate(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'vertical' . DIRECTORY_SEPARATOR . 'style.css'), $id);
        N2JS::addFile(N2Filesystem::translate(dirname(__FILE__) . '/vertical/bar.js'), $id);
