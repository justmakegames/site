...
class N2SSPluginWidgetBulletNumbers extends N2SSPluginWidgetAbstract
{
    ...
    static function render($slider, $id, $params) {
        ...
        N2JS::addFile(N2Filesystem::translate(dirname(__FILE__) . '/../transition/transition/bullet.js'), $id);
        N2CSS::addFile(N2Filesystem::translate(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'numbers' . DIRECTORY_SEPARATOR . 'style.css'), $id);
