...
class N2SSPluginItemInput extends N2SSPluginItemAbstract
{
    ...
    function getTemplate($slider) {
        ...
        return N2Html::tag('div', array(
            ...
            'cellpadding' => 0,
            'cellspacing' => 0
        ), N2Html::tag('tr', array(), N2Html::tag('td', array('style' => '{fullwidthStyle}'), "<div class='n2-fake-input {inputfontclass} {inputstyleclass}' style='width:100%;white-space:nowrap;'>{placeholder}</div>") . N2Html::tag('td', array(), N2Html::tag('div', array(
    ...
    function _renderAdmin($data, $itemId, $slider, $slide) {
        ...
        return N2Html::tag('div', array(
            ...
            'cellpadding' => 0,
            'cellspacing' => 0
        ), N2Html::tag('tr', array(), N2Html::tag('td', array('style' => ($data->get('fullwidth', 0) ? 'width:100%' : '')), "<div class='n2-fake-input " . $inputFont . " " . $inputStyle . "' style='width:100%;white-space:nowrap;'>" . strip_tags($slide->fill($data->get('placeholder', ''))) . "</div>") . $td2)));
    }
