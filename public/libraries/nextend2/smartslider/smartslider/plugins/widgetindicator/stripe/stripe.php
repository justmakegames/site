...
class N2SSPluginWidgetIndicatorStripe extends N2SSPluginWidgetAbstract
{
    ...
    static function render($slider, $id, $params) {
        ...
        N2JS::addFile(N2Filesystem::translate(dirname(__FILE__) . '/stripe/indicator.js'), $id);
        N2CSS::addFile(N2Filesystem::translate(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'stripe' . DIRECTORY_SEPARATOR . 'style.css'), $id);
