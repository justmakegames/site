...
<div id="n2-ss-slide-sidebar" class="smartslider-slide-toolbox-slide-active smartslider-slide-layout-default-active">
    <div id="n2-ss-slide-editor-main-tab" class="n2-table n2-table-fixed n2-sidebar-tab-switcher n2-sidebar-tab-bg">
        <div class="n2-tr">
            ...
            <?php
            ?>
            <div class="n2-td n2-h3 n2-uc n2-has-underline n2-layouts-tab-label">
                <span class="n2-underline"><?php n2_e('Layouts'); ?></span>
            </div>
        <?php
    ...
    <?php
    ?>
    <div class="n2-layouts-tab" style="display:none;">
        <?php require(dirname(__FILE__) . '/_sidebar_layout.php'); ?>
    </div>
<?php
