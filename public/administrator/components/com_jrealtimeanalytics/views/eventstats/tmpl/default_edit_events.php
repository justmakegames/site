				...
				<tbody>
					<?php foreach ($this->eventDetails as $index=>$eventDetail):?> 
						<tr>
							...
							<td><?php echo $eventDetail->geolocation ? $eventDetail->geolocation . ' <img src="' . $this->livesite . '/administrator/components/com_jrealtimeanalytics/images/flags/' . strtolower($eventDetail->geolocation) . '.png"/>' : JText::_('COM_JREALTIME_NOTSET');?></td>
							<?php if(!$this->cparams->get('anonymize_ipaddress', 0)):?>
								<td>
