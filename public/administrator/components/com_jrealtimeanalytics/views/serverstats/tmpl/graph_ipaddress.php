...
<table class="adminlist table table-striped table-hover">
	...
	<tbody>
		<?php foreach ($this->data[TOTALVISITEDPAGESPERIPADDRESS] as $user):?> 
			<tr>
				<td><a data-title="<?php echo JText::_('COM_JREALTIME_DETAILS');?>" class="hasTooltip" target="_blank" href="http://whois.domaintools.com/<?php echo $user[2];?>"><?php echo $user[2];?></a></td>
				<td><?php echo $user[4];?> <img src="<?php echo $this->livesite;?>/administrator/components/com_jrealtimeanalytics/images/flags/<?php echo strtolower($user[4]);?>.png"/></td>
