...
<br/><br/>
<img src="<?php echo JPATH_ROOT;?>/administrator/components/com_jrealtimeanalytics/images/icon-48-statspdf.png"/>&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:18px;">
	<?php echo JText::sprintf('COM_JREALTIME_SERVERSTATS_PAGES_DETAILS', 
			'<span class="label label-info">' . $this->detailData[0]->visitedpage) . '</span>';
	?>
</b>
<hr/>
<table>
	<tr>
		<td style="background-color: #d9edf7;" width="65%">
			<b style="font-size:14px;color: #3a87ad;"><?php echo JText::_('COM_JREALTIME_SERVERSTATS_PAGES_DETAILS_VISITEDUSERS');?></b><br/>
		</td>
		<td width="20%">
