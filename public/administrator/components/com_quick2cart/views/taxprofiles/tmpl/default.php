...
if ($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable', 'taxprofileList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
	<form action="<?php echo JRoute::_('index.php?option=com_quick2cart&view=taxprofiles'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php endif;?>
				...
				<div id="filter-bar" class="btn-toolbar">
					<div class="filter-search btn-group pull-left">
						<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_TAXPROFILES'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_TAXPROFILES'); ?>" />
					</div>
					...
					<table class="table table-striped" id="taxprofileList">
						<thead>
							<tr>
								...
								<th class='left'>
									<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_TAXPROFILES_TAXPROFILE_NAME', 'a.name', $listDirn, $listOrder); ?>
								</th>
						...
						<?php foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if (isset($this->items[0]->state)): ?>
									<td class="center">
										<?php echo JHtml::_('jgrid.published', $item->state, $i, 'taxprofiles.', $canChange, 'cb'); ?>
									</td>
								<?php endif; ?>
								...
								<td>
									...
									<?php endif; ?>
									<?php if ($canEdit) : ?>
										<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=taxprofile.edit&id='.(int) $item->id); ?>">
