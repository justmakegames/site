...
// @ sice version 3.0 Jhtmlsidebar for menu
	...
	<table class="adminlist table table-striped table-bordered table-condensed">
		...
		<tr>
			...
			?>
<!--				<button type="button" class="btn btn-success btn_height" title="<?php echo JText::_( 'SA_NEW' ); ?>" onclick="submitAction('newCoupon');"><i class="<?php echo $qtc_icon_plus; ?> icon-white"></i></button>
				<button type="button" class="btn btn-success btn_height" title="<?php echo JText::_( 'SA_PUBLISH' ); ?>" onclick="submitAction('publish');"><i class="<?php echo $qtc_publish_style;?> icon-white"></i></button>
				<button type="button" class="btn btn-warning btn_height" title="<?php echo JText::_( 'SA_UNPUBLISH' ); ?>" onclick="submitAction('unpublish');"><i class="<?php echo $qtc_unpublish_style;?> icon-white"></i></button>
		-->
