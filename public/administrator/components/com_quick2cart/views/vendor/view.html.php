...
class quick2cartViewVendor extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		else if($layout == "salespervendor")
		{
			...
			{
				$button = "<a href='#' onclick=\"javascript:document.getElementById('task').value = 'csvexport';document.getElementById('controller').value = 'salespervendor';document.adminForm.submit();\" ><span class='icon-32-save' title='Export'></span>" . JText::_('COM_QUICK2CART_SALES_CSV_EXPORT') . "</a>";
