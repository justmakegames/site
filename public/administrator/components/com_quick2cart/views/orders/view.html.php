...
class Quick2cartViewOrders extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if ($layout == 'order' || $layout == 'invoice')
		{
			...
			// $order = $this->comquick2cartHelper->getorderinfo(); // done by Amol
			//  // done by Amol
			$order = $model->getorderinfo($orderid);
	...
	public function addToolbar()
	{
		...
		elseif ($layout != 'invoice')
		{
			...
			JToolBarHelper::custom('orders.resendInvoice', 'repeat', 'repeat', 'COM_QUICK2CART_RESEND_INVOICE', false);
			...
			JToolBarHelper::custom('printOrder', 'print', 'print', 'COM_QUICK2CART_PRINT', false);
