	...
	*/
	...
	function qtcUpdateZoneRule()
	{
		var data = {
			...
			techjoomla.jQuery.ajax({
				type : "POST",
				url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&task=zone.updateZoneRule",
				data : data,
				dataType: "json",
				success : function(response)
				{
			...
			<legend>
				...
				<div class="control-group">
					<div class="control-label">
						...
						{
							$options[] = JHtml::_('select.option', $country['id'],$country['region']);
						}
					...
					<div class="controls" id="">
						<span id="qtcStateContainer">
							...
							//print"<pre>"; print_r($this->getRegionList); die;
