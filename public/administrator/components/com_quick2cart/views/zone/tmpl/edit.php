					...
					success : function(response)
					{
						...
						if (response.error != 1)
						{
							...
							var editLink = '<a rel="{handler:'+q+'iframe'+q+',size:{x: window.innerWidth-450, y: window.innerHeight-150},onClose: function(){window.parent.document.location.reload(true);}}" '
										...
										zoneRuleId+'&tmpl=component" 	class="modal"><input type="button" value="<?php echo JText::_('COM_QUICK2CART_ZONERULE_EDIT'); ?>" class=" btn btn-primary"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
									...
									{ ?>
										<tr>
											...
											<td>
												...
												href="index.php?option=com_quick2cart&view=zone&layout=setrule&id=<?php echo $rule->id;?>&tmpl=component" class="modal">
