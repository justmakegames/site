...
<script type="text/javascript">
	...
	var qtcJsData = {
			Q2C_ICON_TRASH:"<?php echo Q2C_ICON_TRASH; ?> icon-white",
			qtcLoadArributefunction_URL:"index.php?option=com_quick2cart&task=products.loadGlobalAttriOptions&tmpl=component",
			urfnName : function() {
			   return '';
			}
		};
