	...
	<div class="">
				...
				<div id=<?php echo $attribute_container_id ?> class="qtc_mediaContainer qtc_media_hide " >
					<div class="com_qtc_media_repeat_block well well-small span10">
						...
						// CHECK for view override
							...
							$att_list_path=$comquick2cartHelper->getViewpath('products','media',"ADMINISTRATOR","ADMINISTRATOR");
							ob_start();
		...
		<div class="row-fluid">
			<div class="span11 alert alert-info">
				<span><?php echo JText::sprintf("COM_QUICK2CRT_MEDIA_LIMIT_MSG",$eProdMaxFileLimit);?> </span>
			</div>
		</div>
		...
		<div class="row-fluid">
			<div class="span11 alert alert-info">
				<span><?php echo JText::sprintf("COM_QUICK2CRT_MEDIA_SUPPORTED_FILE_TYPES",$allowedFileExtensionsMSG);?> </span>
			</div>
		</div>
