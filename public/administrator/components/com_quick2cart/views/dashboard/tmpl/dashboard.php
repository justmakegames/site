...
<script type="text/javascript">
	...
	function callXML(currversion)
	{
		...
		xhttp.open("GET","<?php echo JUri::base(); ?>index.php?option=com_quick2cart&task=dashboard.getVersion", false);
		xhttp.send("");
		...
		if(latestver!='')
		{
			...
			{
				jQuery('#newVersionNotice').html('<span class="label label-success">'+'<?php echo JText::_("COM_QUICK2CART_HAVE_LATEST_VER");?>: '+latestver+'</span>');
			}
			else
			{
				jQuery('#newVersionNotice').html('<span class="label label-important">'+'* <?php echo JText::_("COM_QUICK2CART_NEW_VER_AVAIL");?>: <span class="jbolo_latest_version_number">'+latestver+'</span></span>');
			}
		}
		else
		{
			jQuery('#newVersionNotice').append(' &nbsp;<span class="label label-important">'+'<?php echo JText::_("COM_QUICK2CART_ERROR_NEW_VERSION");?></span>');
		}
	}
</script>
			...
			<div class="tjDB">
				<div id="wrapper">
					<div id="page-wrapper">
						<div class="row">
							<div class="col-lg-12">
								<div class="pull-right newVersionNotice" id='newVersionNotice'>
									<span class="label label-info">
										<?php echo JText::_('COM_QUICK2CART_HAVE_INSTALLED_VER') . ': ' . $this->version; ?>
									</span>
								</div>
