...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_quick2cart&view=taxrates'); ?>" method="post" name="adminForm" id="adminForm">
		...
		if(!empty($this->sidebar)): ?>
			...
			<div id="filter-bar" class="btn-toolbar">
				<div class="filter-search btn-group pull-left">
					<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_TAXRATES'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_TAXRATES'); ?>" />
				</div>
				...
				<table class="table table-striped" id="taxrateList">
					<thead>
						<tr>
							...
							<th class='left'>
								<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_TAXTRATES_TAXRATE_NAME', 'a.name', $listDirn, $listOrder); ?>
							</th>

							<th class='left'>
								<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_TAXTRATES_TAX_PERCENT', 'a.percentage', $listDirn, $listOrder); ?>
							</th>

							<th class='left hidden-phone'>
								<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_TAXTRATES_ZONE_ID', 'a.zone_id', $listDirn, $listOrder); ?>
							</th>
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td>
									...
									<?php endif; ?>
									<?php if ($canEdit) : ?>
										<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=taxrate.edit&id='.(int) $item->id); ?>">
