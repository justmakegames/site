...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_quick2cart&view=zones'); ?>" method="post" name="adminForm" id="adminForm">
		<?php
		if(!empty($this->sidebar)): ?>
			...
			<?php
				...
				<div class="alert alert-info">
					<?php echo JText::_('COM_QUICK2CART_ZONE_SETUP_HELP'); ?>
				</div>

				<div id="filter-bar" class="btn-toolbar">
					<div class="filter-search btn-group pull-left">
						<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_ZONES'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_QUICK2CART_FILTER_SEARCH_DESC_ZONES'); ?>" />
					</div>
						...
						<thead>
							<tr>
								...
								<th class='left' width="20%">
									<?php echo JText::_('COM_QUICK2CART_ZONES_STORE');?>
								</th>

								<th class='center' width="10%">
									<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_ZONES_ZONE_ID', 'a.id', $listDirn, $listOrder); ?>
								</th>
							</tr>
						</thead>
							...
							foreach ($this->items as $i => $item) :
								...
								<tr class="row<?php echo $i % 2; ?>">
									...
									<td class="left">
										...
										<?php endif; ?>
										<?php if ($canEdit) : ?>
											<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=zone.edit&id='.(int) $item->id); ?>">
