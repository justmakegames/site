...
function qtcLoadPlgMethods()
{
	...
	techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionControllerName; ?>&task=<?php echo $actionViewName; ?>.qtcLoadPlgMethods",
			data : data,
			dataType: "json",
			beforeSend: function()
			{
    ...
    function qtc_updateShipMethod()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionControllerName; ?>&task=<?php echo $actionViewName; ?>.updateShipMethod",
					data : data,
					dataType: "json",
					beforeSend: function()
					{
