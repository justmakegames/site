...
class quick2cartViewSalesreport extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		if (!empty($this->items))
		{
			...
			{
				$button = "<a href='#' onclick=\"javascript:document.getElementById('task').value = 'salesreport.csvexport';document.adminForm.submit();\" ><span class='icon-32-save' title='Export'></span>" . JText::_('COM_QUICK2CART_SALES_CSV_EXPORT') . "</a>";
