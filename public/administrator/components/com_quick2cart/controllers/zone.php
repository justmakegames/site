...
class Quick2cartControllerZone extends JControllerForm
{
	...
	function getStateSelectList()
	{
		...
		if (!empty($country_id))
		{
			...
			$stateList = JHtml::_('select.genericlist', $options, $field_name, ' class="qtc_regionListTopMargin"', 'value', 'text', $default_option, $field_id);
			echo $stateList;
		}
