                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="es-event-labels">
                                    ...
                                    <span class="label label-warning" data-original-title="<?php echo JText::_('COM_EASYSOCIAL_EVENTS_RECURRING_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
