 ...
 */
class SocialAdvancedSearchHelperUser
{
	public $_total 		= null;
	...
	public function getDataKeyHTML($options = array() , $selected = '')
	{
		...
		$output 	= $theme->output( 'site/advancedsearch/user/default.datakey' );
	...
	public function getOperatorHTML( $options = array() , $selected = '' )
	{
		...
		$output 	= $theme->output( 'site/advancedsearch/user/default.operator' );
	...
	public function getConditionHTML( $options = array() , $selected = '' )
	{
		...
		$output 	= $theme->output( 'site/advancedsearch/user/' . $fileName );
	...
	public function getCriteriaHTML( $options = array(), $values = array() )
	{
		...
		return $theme->output( 'site/advancedsearch/user/default.criteria' );
	}
