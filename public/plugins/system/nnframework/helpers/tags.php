...
class NNTags
{
	...
	public static function getRegexSurroundingTagPre()
	{
		return '(?:<(?:p|span)(?: [^>]*)?>\s*(?:(?:</span>|<br ?/?>)\s*)*){0,3}';
	}

	public static function getRegexSurroundingTagPost()
	{
		return '(?:(?:\s*<br ?/?>)*\s*<\/(?:p|span)>){0,3}';
	}
	...
	public static function cleanSurroundingTags($tags)
	{
		$keys = array_keys($tags);

		$string = implode(':|:', $tags);
		while (preg_match('#<(p|span)(?: [^>]*)?>\s*((?:(?:<br ?/?>|:\|:)\s*)*)<\/\1>\s*#s', $string, $match))
		{
