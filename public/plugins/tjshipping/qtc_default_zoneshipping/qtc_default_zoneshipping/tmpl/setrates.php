...
<form name='qtcSetRateform' id="qtcSetRateform"  method="post" class="container-fluid">
	...
	<div class="no-more-tables" id="qtc_shipping_list">
		<table class=" table table-striped">
			<thead>
				<tr>
					<th width="10%"><?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_ZONES"); ?></th>
					...
					<th width="15%"><?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_SHIP_COST"); ?></th>
					<th width="15%"><?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_HANDLE_FEE"); ?></th>
					<th width=""></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_ZONES');?>">
						<?php
						$default = 0;
						$options = array();
						...
						echo JHtml::_('select.genericlist',$options,"zone_id",'class=""col-lg-2 col-md-2 col-sm-2 col-xs-2  required="" aria-invalid="false" size="1" ','value','text',$default,'zone_id');
						?>
					</td>
				...
				<?php //endif; ?>
					...
					<td data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIP_COST');?>">
						<?php
						// Show shipping cost fields
						echo $productHelper->getMultipleCurrFields($name = 'shipCost');
						?>
					</td>
					<td data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_HANDLE_FEE');?>">
						<?php
						// Show shipping cost fields
			...
			foreach ($rateList as $rate)
			{
				...
				<tr id="qtcRateId_<?php echo $rate['rateId'];?>">
					...
					<td id="qtcActionTd_<?php echo $qtcRateId;?>" >
						...
						href="<?php echo JRoute::_($editRateLink); ?>" class="modal">
